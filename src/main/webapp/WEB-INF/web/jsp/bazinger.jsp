...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    <head>
        ...
        <link rel="stylesheet" href="${resourcesFolder}theme/bazinger/assets/css/bootstrap.min.css">
        <!--        <link rel="stylesheet" href="assets/css/bootstrap-theme.min.css">-->


        <!--For Plugins external css-->
        <link rel="stylesheet" href="${resourcesFolder}theme/bazinger/assets/css/plugins.css" />
        <link rel="stylesheet" href="${resourcesFolder}theme/bazinger/assets/css/lato-webfont.css" />
        <link rel="stylesheet" href="${resourcesFolder}theme/bazinger/assets/css/magnific-popup.css">



        <!--Theme custom css -->
        <link rel="stylesheet" href="${resourcesFolder}theme/bazinger/assets/css/style.css">

        <!--Theme Responsive css-->
        <link rel="stylesheet" href="${resourcesFolder}theme/bazinger/assets/css/responsive.css" />

        <script src="${resourcesFolder}theme/bazinger/assets/js/vendor/modernizr-2.8.3-respond-1.4.2.min.js"></script>
    </head>
    <body>
        <!--[if lt IE 8]>
        ...
        <script src="${resourcesFolder}theme/bazinger/assets/js/gmaps.min.js"></script>

        <script src="${resourcesFolder}theme/bazinger/assets/js/jquery.magnific-popup.js"></script>

        <script src="${resourcesFolder}theme/bazinger/assets/js/plugins.js"></script>
        <script src="${resourcesFolder}theme/bazinger/assets/js/main.js"></script>
    </body>
</html>
